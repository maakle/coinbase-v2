...
-(void) getTransactions:(NSString *)accountId  callback:(void(^)(NSArray <CoinbaseTransaction *>*, CoinbaseUser*, CoinbaseBalance*, CoinbaseBalance*, CoinbasePagingHelper*, NSError*))callback;
